...
export function EmptyState({
  ...
  return (
    <div className={`flex min-h-52 flex-col items-center justify-center rounded-lg border border-dashed border-line bg-white px-6 py-10 text-center ${className ?? ""}`}>
