...
from app.ml.explanation_builder import build_analysis_explanation
...
class AnalysisService:
    ...
    def analyze(self, payload: AnalyzeTicketRequest) -> AnalyzeTicketResponse:
        ...
        explanation = build_analysis_explanation(
            text=combine_title_description(payload.title, payload.description),
            category=category,
            ...
            detected_signals=priority_result.get("detected_signals", []),
        )
